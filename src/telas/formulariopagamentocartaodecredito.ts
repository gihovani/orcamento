...
export class FormularioPagamentoCartaoDeCredito implements ITela {
    ...
    public pegaDadosDoFormulario(form: HTMLFormElement): ICartaoDeCredito {
  ...
  <button type="submit" class="btn btn-primary">SALVAR</button>
        ...
        this.apiParcelamento.consultar('cartaodecredito', this.carrinho).then((maximoParcelas) => {
        ...
        main.querySelector('#numero')?.addEventListener('change', (e) => {
        ...
        form.addEventListener('submit', (e) => {
            ...
            this.notificacao.mostrar('Sucesso', `Os Dados do Cartão de Crédito (${cartaoDeCredito.numero}) Foram Salvos!`);
        });
        return main;
    }
}